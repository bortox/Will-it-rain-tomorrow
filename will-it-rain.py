...
owm = OWM('Place your OWM api key here')
...
class App(QWidget):
    ...
    def initUI(self):
        ...
        self.labelB.setText(self.cname)
    ...
    def selectcity(self):
        ...
        while True:
            text, okPressed = QInputDialog.getText(self, "City Name", "City Name ( e.g. London, GB ):",
                                                   QLineEdit.Normal, "")
            if okPressed and text != '':
                ...
                if len(matchlist) == 0:
                    showerror(title='No city found', shorttext='No city has been found.',
                              infotext='Check your spelling.')
                else:
                    try:
                        self.cname = city
                    except:
                        self.cname = text + ',' + matchlist[0][2]
                    self.labelB.setText('Click to get forecast for ' + self.cname)
